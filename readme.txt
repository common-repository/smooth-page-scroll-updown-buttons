...
1. In your WordPress admin, go to PLUGINS and activate "Smooth Page Scroll Up/Down Buttons"
1. Go to SETTINGS - SMOOTH SCROLL PAGE UP/DOWN BUTTONS
1. Choose the layout (where you want the buttons to appear) and the scroll speed
